      ...
      <div className="delivery-collections ml-1 mt-2">
          ...
          <div className="text-2xl  font-semibold pl-4 pt-7 pb-7 text-gray-500">
            ...
            <Carousel   className=" pt-7" responsive={responsive}>
              <div  className=" cursor-pointer    w-166.6 h-150">
                <img className=" cursor-pointer  hover:bg-gray-400  rounded-full w-40 flex justify-center items-center"
                ...
                <h2 className=" font-normal text-lg">25 min</h2>
              </div>
              <div  className="  ">
                <img className=" cursor-pointer  hover:bg-gray-400  w-40 rounded-full flex justify-center items-center"
                src="https://b.zmtcdn.com/data/brand_creatives/logos/381f5d7481d4cf08b35a063b8787070b_1617918168.png"
                alt="pizza" />
                <h1 className="pb-4">Sree Annapoorna</h1>
                <h2 className=" font-normal text-lg">13 min</h2>
              </div>
              <div >
                <img className=" cursor-pointer  hover:bg-gray-400 rounded-full  w-40 flex justify-center items-center"
              ...
              <div >
                ...
                <h2 className=" font-normal text-lg">20 min</h2>
              </div>
              <div >
                <img className=" cursor-pointer  hover:bg-gray-400 rounded-full  w-40 flex justify-center items-center"
                ...
                <h2 className=" font-normal text-lg">48 min</h2>
              </div>
              <div >
                <img className="  hover:bg-gray-400 rounded-full  w-40 flex justify-center items-center"
                ...
                <h2 className=" font-normal text-lg">35 min</h2>
              </div>
              <div > 
                <img className="  cursor-pointer rounded-full w-40 flex justify-center items-center"
                ...
                <h2 className=" font-normal text-lg">49 min</h2>
              </div>
            </Carousel>
          </div>
